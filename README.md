...
# 1. Функциональные требования:
  ...
  2. Ролевая система(Клиент, Сотрудник, Админ).
  3. Ведение журнала действий пользователя.(Покупки, Отзывы)
  4. Просмотр сортудников(Клиент)
  5. Управление Товароми, Производитлями (Сотрудник).
  6. Управление отзывами CRUD (Админ).
